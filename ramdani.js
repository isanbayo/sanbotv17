...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ʙʏ sanBot","listType": "SINGLE_SELECT","sections": list}}, {})
...
"externalAdReply": {
                ...
                "body": `${faketroli}`,
                "mediaType": "10",
                "mediaUrl": `https://www.youtube.com/channel/UCFOykSFkmdHko5xIr-zNmYQ`,
                "thumbnailUrl": "https://www.youtube.com/channel/UCFOykSFkmdHko5xIr-zNmYQ",
                "thumbnail": fakeimg,
                "sourceUrl": `https://www.youtube.com/channel/UCFOykSFkmdHko5xIr-zNmYQ`,
      ...
      const demoteAdmin = async function(to, target=[]){
          ...
          if (!packname) packname = 'Dibuat Oleh'; if (!author) author = '© sanBot';author = author.replace(/[^a-zA-Z0-9]/g, '');	
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/foto/thumb.jpg`)},"title": `© ʙʏ sanBot`,"description": "sanBot", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "sanBot","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
danzrun = process.uptime() 
           Ramdani.setStatus(`${namabot} Aktif Selama ${(danzrun)} © Creator By sanBot`).catch((_)=>_); //DI UBAH YATIMM
...
> 532 ${prefix}nsfw_avatar`
               ...
               buttonsMessage = {
               contentText: `${allmenu}`,
               footerText: '© ʙʏ sanBot', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
freply(`*SILAHLAN HUBUNGI*\nhttp://wa.me/628975767944?text=bang+mau+order+jasa+run+heroku:v`)
break
//JASA UP HEROKU
case 'jasaupgithub':
case 'jasaup':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
freply(`*SILAHLAN HUBUNGI*\nhttp://wa.me/628975767944?text=bang+mau+order+jasa+up+github:v`)
break
//STORE MENU//
//TOP UP GAME
case 'topupgame2':
...
case 'tiktok':
              ...
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt sanBot\n Help 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan':
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI sanBot\`\`\`')
...
case 'ttp':
              if (!isRegist) return freply(mess.regist)
              if (isBanned) return freply(mess.banned)
              if (args.length == 0) return freply(`Example: ${prefix + command} sanBot`)
              woy = args.join(" ")
              freply(mess.wait)
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *© ʙʏ sanBot* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
              if (!isRegist) return freply(mess.regist)
              if (isDewasa) return freply(mess.dewasa)
...
Ramdani.sendMessage(from, tapib1, document, { quoted: mek, filename:`sanBot ~ 404 ${danz}.mp3`, mimetype: 'audio/application' })
...
"groupInviteMessage": {
"groupJid": "628975767944-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": "162533333338378",
"groupName": `sanBot ~ 404 ${danz}`,
...
"caption": "https://chat.whatsapp.com/GwQy6yi9B80Cd9hP4aDbzS",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
"businessOwnerJid": "628975767944@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
//------------------< Lainnya >-------------------
      ...
      case 'caripesan':
       ...
       case 'bugreport':
              ...
              Ramdani.sendMessage('628975767944@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
              if (!isRegist) return freply(mess.regist)
              if (isBanned) return freply(mess.banned)
